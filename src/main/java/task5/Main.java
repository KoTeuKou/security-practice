...
public class Main {
    ...
    private static final String alphabet = "אבגדהו¸זחטיךכלםמןנסעףפץצקרשתûü‎‏ÿ0123456789.?!,;:-()\" ";
    ...
    public static void main(String[] args) throws IOException {
        ...
        task5Encoder.getVigenereEncrypt(vigenereMatrix, "ךמעÿנא", "./src/main/resources/text_for_task5");
        task5Decoder.vigenereDecrypt(vigenereMatrix, "ךמעÿנא", "./src/main/resources/encoded5TaskFile.txt");
